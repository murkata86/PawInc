namespace PawIcn.Models.Commands
{
    ...
    public class RegisterDog : Command
    {
        ...
        public RegisterDog(string[] data, IDatabase database, IAnimalFactory animalFactory) : 
            base(data, database)
        {
        ...
        public override void Execute()
        {
            ...
            IAnimal animal = this.animalFactory.CreateAnimal("Dog", name, age, intelligenceCoefficient);
